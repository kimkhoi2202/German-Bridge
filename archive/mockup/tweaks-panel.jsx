...
const __TWEAKS_STYLE = `
  .twk-panel{position:fixed;right:16px;bottom:calc(var(--bottom-nav-h, 64px) + 16px);z-index:2147483646;width:280px;
    max-height:calc(100vh - var(--bottom-nav-h, 64px) - 32px);display:flex;flex-direction:column;
